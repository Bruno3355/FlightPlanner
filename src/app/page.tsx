  ...
  return (
    <div className="w-screen h-screen relative bg-white overflow-hidden">
      ...
      <FourGridContainer active={active}>
        <Card classAtributes={`col-start-1 col-end-2 row-start-1 row-end-1`} />
        <Card classAtributes={`col-start-2 col-end-3 row-start-1 row-end-1`} />
        <Card classAtributes={`col-start-1 col-end-2 row-start-2 row-end-3`} />
        <Card classAtributes={`col-start-2 col-end-3 row-start-2 row-end-3`} />
      </FourGridContainer>
    </div>
  );
}
